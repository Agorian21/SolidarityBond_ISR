    ...
    $(document).ready(function(){
        ...
        error: function(d){
            alert("L'API ne répond pas, veuillez relancer le serveur.");
                    ...
                    <form role="form" method="post" action="../PHP/manage/scriptDeleteComment.php">
						<fieldset>							
							<p class="text-uppercase pull-center"> Supprimer un commentaire </p>	
 							<div class="form-group">
								<input type="text" name="id" id="id" class="form-control input-lg" placeholder="Identifiant du commentaire à supprimer">
                            </div>
